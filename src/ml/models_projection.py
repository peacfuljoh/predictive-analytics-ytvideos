...
from src.crawler.crawler.constants import FEATURES_VECTOR_COL, ML_MODEL_TYPE, ML_MODEL_TYPE_LIN_PROJ_RAND, \
    ML_MODEL_HYPERPARAMS, ML_HYPERPARAM_EMBED_DIM, ML_HYPERPARAM_RLP_DENSITY
...
class MLModelProjection():
    """Parent class for projection models."""
